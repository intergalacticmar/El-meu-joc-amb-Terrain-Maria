...

{
    ...
    void Update()
    {
       ...
       if(Input.GetButton("Fire2") && _gameManager._muerte == false)
       {
            AimMovement();
       }


      else if (_gameManager._muerte == false)
        {
            Movement();    
        }


        if(_gameManager._muerte == false)
        {
            Jump();
        }
    ...
    void Jump()
    {
        ...
        _controller.Move(_playerGravity * Time.deltaTime);
         ...
         void Die()
        {
            if(Input.GetKey(KeyCode.P) &&  _gameManager._muerte == false)
            {
                _gameManager.PlayerMuerte();
